/**
 * JuegoPanel: Panel que se usa de forma general.
 * 
...
public class JuegoPanel extends GeneralPanel {
  ...
  private static final Font TITULO_FUENTE = new Font("SansSerif", Font.BOLD, 24);
  ...
  public void paintComponent(Graphics g) {
    ...
    g.setFont(TITULO_FUENTE);
    g.setColor(Color.BLACK); // Color del texto

    // Calcular la posición X centrada
    FontMetrics metrics = g.getFontMetrics(TITULO_FUENTE);
